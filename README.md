...
This project was motivated by the [Building a MovieLens Recommender System workshop](https://www.youtube.com/watch?v=XfAe-HLysOM&t=3257s). The linked workshop uses MovieLens; the notebook in this repository uses **Instacart** order data and an **implicit ALS** model. It is presented as a tutorial-based learning exercise.
